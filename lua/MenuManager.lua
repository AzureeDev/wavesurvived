...
WaveSurvivedTweakData.supported_hud[2] = "holoui"
WaveSurvivedTweakData.supported_hud[3] = "pdth_hud"
WaveSurvivedTweakData.supported_hud[4] = "lddg_hud"
WaveSurvivedTweakData.supported_hud[5] = "restoration"
